...
public class EtymologyProblem extends PslProblem {
	...
	public EtymologyProblem(EtymologyConfig config) {
		super(config);
		addInteractionRules();
	...
	public EtymologyProblem fromConfig(EtymologyConfig config) {
	...
	public void addInteractionRules() {
		EtymologyConfig config = (EtymologyConfig) super.getConfig();
	...
	public EtymologyConfig getEtymologyConfig() {
		return (EtymologyConfig) super.getConfig();
	}
