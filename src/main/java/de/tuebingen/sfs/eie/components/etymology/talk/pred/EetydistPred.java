...
public class EetydistPred extends TalkingPredicate {

	public static final String NAME = "Eetydist";
	...
	public String verbalizeIdeaAsSentence(double belief, String... args) {
		...
		sb.append(" ultimately etymologically derived from ").append(args[1]);
		return sb.toString();
	}
	...
	public String verbalizeIdeaAsNP(String... args) {
		StringBuilder sb = new StringBuilder();
		sb.append("(ultimate) etymological derivation of ").append(args[0]).append(" from ").append(args[1]);
		return sb.toString();
	}
