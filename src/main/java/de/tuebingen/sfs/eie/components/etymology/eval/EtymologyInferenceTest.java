...
public class EtymologyInferenceTest {
	...
	public static void main(String[] args) {
		// For debugging with a GUI, use the EtymologyFactViewer in the etinen repo.
		...
		EtymologyProblem psl = new EtymologyProblem(problemManager.getDbManager(), "EtymologyProblem", wordListDb,
				phonSimHelper, net, phylogeny);
